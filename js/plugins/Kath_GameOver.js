...
Kath.Param.PartyDeathCommonEventID = Number(Kath.Parameters['Party Death Common Event ID']);
...
Kath.Param.AfterGameOverCommonEventID = Number(Kath.Parameters['After Game Over Common Event ID']);
