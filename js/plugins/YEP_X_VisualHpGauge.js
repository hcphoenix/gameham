...
// Draw MP as well
Window_VisualHPGauge.prototype.drawEnemyMp = function(enemy, x, y, width) {
    width = width || 186;
    if (this._battler._enemyId&&this._battler.mp>0){
    this.drawGauge(0,4, width, this._battler.mp/this._battler.mmp, this.mpGaugeColor1(), this.mpGaugeColor1());
...
Window_VisualHPGauge.prototype.updateRefresh = function() {
  if (this._requestRefresh) this.refresh();
      if (this._battler._enemyId&&this._displayedMpValue != this._battler.mp&&this._battler.mp>0){
  this._displayedMpValue = this._battler.mp;
  this.drawEnemyMp();
  };
