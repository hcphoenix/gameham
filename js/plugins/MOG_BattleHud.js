...
Battle_Hud.prototype.create_face = function() {
	...
	if (!this._battler) {return};
    // ImageManager.loadBHud to load the custom face instead of default
    ...
    let face_index = this._battler.faceIndex();
    let face_width = Window_Base._faceWidth;
    let face_height = Window_Base._faceHeight;
    let face_index_x = face_index % 4 * face_width;
	...
	if (this._hp_meter_blue) {
		if(this._hp_flow[0]) {
		   ...
		   if (this._hp_flow[1] > this._hp_flow[3]) {this._hp_flow[1] = 0};		   
            ...
            this.refresh_meter(this._hp_meter_red,1,1,1);
	...
	if (this._mp_meter_blue) {
		if(this._mp_flow[0]) {
		   ...
		   if (this._mp_flow[1] > this._mp_flow[3]) {this._mp_flow[1] = 0};		   
            ...
            this.refresh_meter(this._mp_meter_red,1,1,1);
